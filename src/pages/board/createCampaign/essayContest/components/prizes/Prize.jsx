    ...
    return (
        <div className='grid xs:grid-cols-1 lg:grid-cols-2 mt-5 xs:gap-4 md:gap-8'>
            <div className='w-full flex flex-col'>
              ...
              {errors.prize && errors.prize[index]?.name && touched.prize && touched.prize[index]?.name ? (
                <div className='text-RED-_100'>{errors.prize[index].name}</div>
              ) : null}
        </div>
          ...
          <div className='w-full flex flex-col '>
            ...
            <div className='xs:w-full h-[44px]'>
                ...
                />
                {errors.prize && errors.prize[index]?.winners && touched.prize && touched.prize[index]?.winners ? (
                  <div className='text-RED-_100'>{errors.prize[index].winners}</div>
                ) : null}
            </div>
          </div>
          ...
          <div className='flex xs:flex-col mt-3 md:flex-row gap-4 w-12/12'>
            <div className="flex flex-col xs:w-full md:w-4/12">
              {prize?.imageDoc
                ? 
                  <div className="pt-0 " >
                      <img alt="upload" width={"300px"} height={"100px"} src={URL.createObjectURL(prize?.imageDoc)} />
                  </div>
                ...
                <input
                  ...
                  onChange={(e) => setFieldValue(`prize[${index}].imageDoc`, e.target.files[0])}
                  id="upload"
                  accept={"image/*"}
                  multiple={false}
                />
