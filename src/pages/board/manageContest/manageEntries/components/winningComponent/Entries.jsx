...
const Entry = () => {
  ...
  return (
    <div className='bg-[#fff] p-2 rounded-b-md'>
          ...
          <div className='grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xs:p-0 md:p-4 lg:p-1  xs:mx-4  xs:gap-4 md:gap-2'>
              {
                  entryData.length > 0 ? entryData.map((data) => (
                      <div key={data?.id} className='xs:w-full md:w-full lg:w-[209px] lg:h-[263px] bg-white'>
                      ...
                      <div className='p-3 flex flex-col gap-1'>
                          ...
                          {/* <button className="xs:w-[80px] xs:h-[30px] md:w-[100px] md:h-[49px] bg-secondary rounded-3xl text-white xs:text-xs md:text-sm">
                              <Link to="/champions/details/:id" state={data}>
                                  {t("readMore")}
                              </Link>  
                          </button> */}
                      </div> 
                  ...
                  : 
                  <div className='flex flex-row justify-center text-center text-3xl font-bold '>{t("notFound")}</div>
              } 
          </div>
      ...
      <ModalPop isOpen={false}> </ModalPop>
    </div>
